...
class PositionUtilTest extends GroovyTestCase{
	...
	void testOpenPositions(){
		...
		assert [1,2,3,4,5,6,7,8,9] == util.openPositions(board)
	}
	
	@Test
	void testOpenPositions_SomeMarked(){
		...
		assert [1,3,4,6,7,9] == util.openPositions(board)
	}
	
	@Test
	void testOpenPositions_AllMarked(){
		...
		assert [] == util.openPositions(board)
	}
